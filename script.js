  ...
  mainContent.insertAdjacentHTML('beforeend', `
    <div class="flex flex-col items-center protocol-page">
      ...
      <div class="card-stitch w-full mb-8 relative border-primary/10 bg-white/[0.02] flex flex-col items-center pt-12 pb-8 px-6">
        <div class="absolute -top-3 inset-x-0 mx-auto px-4 py-1.5 rounded-full bg-accent text-black text-[10px] font-black uppercase tracking-widest shadow-2xl whitespace-nowrap w-max z-20">⚡ LANÇAMENTO — 74% OFF</div>
